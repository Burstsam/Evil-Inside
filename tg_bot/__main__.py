...
TECHNO_IMG = "https://telegra.ph/file/3553fec4fff03575b1ddf.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="𝙷𝙴𝙻𝙿",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Kawaii Support Chay",
                                                                       url="t.me/Marin_Support")],
                                                                                   [InlineKeyboardButton(text= "Owner",
                                                                       url="https://t.me/im_the_ownerr"),
                                                                                   InlineKeyboardButton(text="Off Topic",
